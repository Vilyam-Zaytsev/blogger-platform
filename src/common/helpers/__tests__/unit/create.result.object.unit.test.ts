...
describe('CREATE RESULT OBJECT', () => {
    ...
    it('should create a result object with the Successful status, with the "data: null" field (using the static' +
    ...
    it('should create a result object with the Successful status, with data (using the static "positive" method of the Result Object class).', () => {
    ...
    it('should create a result object with the Successful status that does not contain data (using the SuccessResult class).', () => {
