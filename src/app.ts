...
import {blogsRouter} from "./04-blogs/api/blogs-router";
import {postsRouter} from "./05-posts/api/posts-router";
import {testsRouter} from "./autotest/tests-router";
import {authRouter} from "./01-auth/api/auth-router";
import {usersRouter} from "./03-users/api/users-router";
import {commentsRouter} from "./06-comments/api/comments-router";
